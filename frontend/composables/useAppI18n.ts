...
const dictionary: Record<'pt' | 'en', Record<string, any>> = {
  pt: {
    ...
    keywords: {
      ...
      toast_rate_limit_msg: '⚠️ Limite de segurança de IA atingido (máx. 2 consultas a cada 3 horas). Sua cota será restaurada em {time}.',
  ...
  en: {
    ...
    keywords: {
      ...
      toast_rate_limit_msg: '⚠️ AI security limit reached (max 2 queries every 3 hours). Your quota will be restored in {time}.',
